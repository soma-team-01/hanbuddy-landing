...
2. ⭐ **24시간 안에 선택한 연락 수단으로 연락해 자리를 확정한다는 약속.** 그 연락에서 참가 가능 여부, 결제, 집결 장소, 최종 일정을 정한다.
...
```
We’ll message you on KakaoTalk within 24 hours to confirm your spot.
24시간 안에 카카오톡으로 연락드려 자리를 확정해 드립니다.
```
