...
- `assets/photos/kleague/*.webp` are team-owned K League photos (from the team Drive). `assets/photos/jjimjilbang/jjimjilbang-bulgama.webp` is a CC0 (public domain) Wikimedia Commons photo with no people — source: commons.wikimedia.org File:2020-03-11_20.39.31_찜질방_불가마.jpg; no attribution required, but keep this note for provenance.
