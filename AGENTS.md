...
- Team repo rules: always branch + PR (main direct push is hook-blocked), squash merge, no AI co-author trailers in commits or PR bodies. PR titles and commit titles must use the pattern `feat: <한국어 요약>`; `<한국어 요약>` must be a short, clear Korean summary of the actual change.
