...
- Event **URLs** were left alone on 2026-08-06 (`/events/kbo/` still serves the Gocheok page). Links to them may already be out in Meetup posts and Instagram, and the ids carry the data that matters. Rename them together with redirects once the August runs are over.
