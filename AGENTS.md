...
- `assets/photos/kleague/*`, `assets/photos/samgyeopsal/*`, and `assets/photos/chimaek/*` are team-owned. `kleague-0815-scarf.webp` is from the 2026-08-15 run (team phone shot; the four identifiable bystander faces in the crowd are Gaussian-blurred, no participant face appears). Only `chimaek-table.webp` shows a person (a guest from the shoulders down, consent recorded 2026-08-10). Every other food photo was chosen or cropped so that no person appears at all: `samgyeopsal-table.webp` is cropped 24% off the top for exactly this reason, and shots where people were central to the frame were left out of the set. The CC0 jjimjilbang photos were deleted on 2026-08-10 with the activity.
