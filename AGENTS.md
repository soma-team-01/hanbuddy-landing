...
- Meeting time follows one rule: **5:30 PM on weekdays, 5:00 PM on weekends**. This is when the group gathers, not when the game starts, so public copy says "meet at" rather than a bare time.
