...
- `assets/photos/kleague/*`, `assets/photos/samgyeopsal/*`, and `assets/photos/chimaek/*` are team-owned. All three kleague photos are from the 2026-08-15 run; the three pre-run stadium photos (`kleague-worldcup-day`, `kleague-night`, `kleague-kickoff`, personal shots from before HanBuddy) were deleted on 2026-08-22 when the run's own photos replaced them. `kleague-0815-scarf.webp` is a team phone shot (the four identifiable bystander faces in the crowd are Gaussian-blurred, no participant face appears). `kleague-0815-crew.webp` shows the two guests and their buddy in a selfie — both guests answered "Yes, I consent." to the photo-use question in the 2026-08-16 survey responses — with identifiable bystander faces in the crowd band Gaussian-blurred. `kleague-0815-dusk.webp` is a stands-level stadium view whose nearest identifiable bystander faces are Gaussian-blurred (rest are backs of heads or too distant); it also serves as the `#apply` backdrop slide. Only `chimaek-table.webp` shows a person (a guest from the shoulders down, consent recorded 2026-08-10). Every other food photo was chosen or cropped so that no person appears at all: `samgyeopsal-table.webp` is cropped 24% off the top for exactly this reason, and shots where people were central to the frame were left out of the set. The CC0 jjimjilbang photos were deleted on 2026-08-10 with the activity.
